    ...
    <main class="absolute top-0 left-0 backdrop-blur w-screen h-screen flex justify-center items-center px-4">
      ...
      >
        <div class="flex flex-col items-center gap-4">
          <h1 class="text-4xl text-center sm:text-5xl font-worldAthleticsHeading">Niet gevonden!</h1>
          <p class="font-bold text-center text-lg sm:text-xl">Deze pagina bestaat (niet) meer.</p>
        </div>
